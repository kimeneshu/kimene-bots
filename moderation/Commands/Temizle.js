...
module.exports.run = async(client, message, args, embed) => {
    if (!message.member.hasPermission(8192)) return message.channel.send(embed.setDescription(`${message.author}, Bu komutu kullanmak için yeterli yetkiye sahip değilsin!`)).sil(7);
...
exports.config = {
    name: "sil",
    usage: `${ayar.bot.botPrefix}sil sayı`,
    guildOnly: true,
    aliases: ["temizle"],
    cooldown: 3000
};
