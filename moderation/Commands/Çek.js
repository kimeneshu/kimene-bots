...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım örnek: **${ayar.bot.botPrefix}git @Kimene/ID**`)).sil(7);
...
exports.config = {
    name: "çek",
    usage: `${ayar.bot.botPrefix}çek [@Kimene/ID]`,
    guildOnly: true,
    aliases: ["cek"],
    cooldown: 3000
};